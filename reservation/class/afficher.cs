...
//                //{
//                //    using (SqlCommand cmd = new SqlCommand(req, sqlconn.reqSql))
...
//                int indexNouvelleLigne = rsv.getDataTble.Rows.Add();
...
//                            DataGridViewRow nouvelleLigne = rsv.getDataTble.Rows[indexNouvelleLigne];
